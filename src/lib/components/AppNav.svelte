...
<div class="container btm-nav border-t border-nav-border z-40">
	<!-- <button
	...
	>
		{#if path === '/'}
			...
			<span class="btm-nav-label font-bold">Home</span>
		{:else}
			<svg
				xmlns="http://www.w3.org/2000/svg"
				class="h-5 w-5"
	...
	>
		{#if path === '/account'}
			...
			<span class="btm-nav-label font-bold">Settings</span>
		{:else}
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
