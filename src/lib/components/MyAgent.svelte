					...
					<div class="flex flex-col justify-center items-start gap-4 py-4">
						<div class="flex flex-row justify-center items-center gap-1">
							...
							{#if $currentUser.expand.agent.contact_email}
								<span class="text-sm">{$currentUser.expand.agent.contact_email}</span>
							{:else}
								<span class="text-sm">{$currentUser.expand.agent.email}</span>
							{/if}
						</div>
						{#if $currentUser.expand.agent.contact_number}
							<div class="flex flex-row justify-center items-center gap-1">
								...
								<span class="text-sm">{$currentUser.expand.agent.contact_number}</span>
							</div>
						{/if}
					</div>
				</div>
